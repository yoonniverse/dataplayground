...
Generalized Linear Models (GLM) allows us to model probability distribution in exponential family. Probability distribution of exponential family consists every distributions that can be expressed like below.
...
Three examples are Bernoulli distribution, Gaussian distribution, and Categorical distribution.
