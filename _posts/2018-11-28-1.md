...
I'll follow the [Neural Style Transfer with Eger Execution](https://colab.research.google.com/github/tensorflow/models/blob/master/research/nst_blogpost/4_Neural_Style_Transfer_with_Eager_Execution.ipynb) tutorial, with additional parts with *ITALIC* fonts to understand the code better. In this tutorial, 'VGG19' was used to find features of images.

Look at https://harangdev.github.io/deep-learning/convolutional-neural-networks/33/ for basic knowledge about neural style transfer.
